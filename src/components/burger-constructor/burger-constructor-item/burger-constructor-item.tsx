...
const BurgerConstructorItem: FC<TBurgerConstructorItemProps> = ({ ingredient, onDelete, index, onSwap }) => {
  ...
  return (
    <div className={`${styles.item} cursor-grab`} ref={ingredientRef}>
      ...
      <ConstructorElement text={ingredient.name} price={ingredient.price} thumbnail={ingredient.image} handleClose={() => onDelete(ingredient._id)} />
    </div>
  )
}
